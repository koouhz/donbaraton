...
const ROUTE_PERMISSIONS = {
    ...
    '/cuentas-por-pagar': [ROLES.ADMINISTRADOR, ROLES.CONTADOR, ROLES.GERENTE],
    ...
    '/ordenes-compra': [ROLES.ADMINISTRADOR, ROLES.ENCARGADO_COMPRAS, ROLES.GERENTE],
    '/proveedores': [ROLES.ADMINISTRADOR, ROLES.ENCARGADO_COMPRAS, ROLES.ENCARGADO_ALMACEN, ROLES.GERENTE],
    ...
    '/devoluciones': [ROLES.ADMINISTRADOR, ROLES.GERENTE, ROLES.ENCARGADO_ALMACEN],

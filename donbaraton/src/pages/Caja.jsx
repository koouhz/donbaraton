...
export default function Caja() {
  ...
  // NOTA: Usar fecha LOCAL (Bolivia -4) para que coincida con las ventas del día.
  // toISOString() devuelve UTC que puede ser el día siguiente después de las 20:00 Bolivia.
  const hoy = (() => {
    const d = new Date();

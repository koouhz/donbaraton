import{c as k,r as l,s as u,j as t,P as y,p as $}from"./index-DyRGlXyn.js";import{n as c,F as A,L as v}from"./index-Bk6qzOxF.js";import{R as P}from"./refresh-cw-VSjeutiz.js";import{F as I}from"./file-down-B7taR7BA.js";import{D as B}from"./dollar-sign-BJpoOmkd.js";import{T as D}from"./triangle-alert-DqqKGNFw.js";const F=[["rect",{width:"20",height:"5",x:"2",y:"3",rx:"1",key:"1wp1u1"}],["path",{d:"M4 8v11a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8",key:"1s80jp"}],["path",{d:"M10 12h4",key:"a56b0p"}]],L=k("archive",F);const R=[["path",{d:"M12.83 2.18a2 2 0 0 0-1.66 0L2.6 6.08a1 1 0 0 0 0 1.83l8.58 3.91a2 2 0 0 0 1.66 0l8.58-3.9a1 1 0 0 0 0-1.83z",key:"zw3jo"}],["path",{d:"M2 12a1 1 0 0 0 .58.91l8.6 3.91a2 2 0 0 0 1.65 0l8.58-3.9A1 1 0 0 0 22 12",key:"1wduqc"}],["path",{d:"M2 17a1 1 0 0 0 .58.91l8.6 3.91a2 2 0 0 0 1.65 0l8.58-3.9A1 1 0 0 0 22 17",key:"kqbvx6"}]],j=k("layers",R);function H(){const[p,S]=l.useState([]),[i,z]=l.useState([]),[x,f]=l.useState(!0),[b,g]=l.useState(!1),[a,C]=l.useState({totalCategorias:0,totalProductos:0,stockTotal:0,valorTotal:0});l.useEffect(()=>{m()},[]);const m=async()=>{f(!0);try{const{data:o,error:s}=await u.rpc("fn_reporte_inventario_valorado");s?(console.error("Error:",s),c.error("Error al cargar inventario valorado")):(S(o||[]),T(o||[]));const r=await u.rpc("fn_alerta_stock_critico");r.error||z(r.data||[])}catch(o){console.error("Error:",o),c.error("Error al cargar datos")}finally{f(!1)}},T=o=>{const s=o.reduce((n,d)=>n+parseInt(d.cantidad_productos||0),0),r=o.reduce((n,d)=>n+parseInt(d.stock_total||0),0),_=o.reduce((n,d)=>n+parseFloat(d.valor_venta_potencial||0),0);C({totalCategorias:o.length,totalProductos:s,stockTotal:r,valorTotal:_})},w=async()=>{g(!0);try{const o=`
        <!DOCTYPE html>
        <html>
        <head>
          <meta charset="utf-8">
